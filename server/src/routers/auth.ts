...
const router = Router();
const { register, login, getUser, activation, forgetPassword, resetPassword, updateData } = AuthController;

const { validateLogin, validateSign, resetPasswordValidator, forgetPasswordValidator } = validate;
